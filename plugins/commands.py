...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Join Our Channel?", url="https://t.me/musi_c_world"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/musi_c_world"),
                    InlineKeyboardButton("Support Group", url="https://t.me/musi_c_world")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "JOIN", url="https://t.me/musi_c_world")
                ],
                [
